...
ORDER BY d.year_num, d.month_num, b.branch_code;
...
HAVING count(*) >= 5
ORDER BY contribution_margin DESC, transaction_count DESC, c.customer_number, d.year_num, d.month_num
LIMIT 500;
...
ORDER BY d.full_date, expected_credit_loss DESC;
...
ORDER BY suspicious_count DESC, total_amount DESC, c.customer_number
LIMIT 300;
...
ORDER BY d.full_date, p.product_type, p.product_name, fb.currency_code;
