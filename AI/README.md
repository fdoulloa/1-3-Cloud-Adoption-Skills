...
- [LiteLLM SearXNG AICoding Gateway Single ECS](./AI-Coding/LiteLLM-SearXNG-AICoding-Gateway-Single-ECS/README.md) — Single-host LiteLLM + SearXNG MCP gateway on Huawei Cloud ECS, wired into Claude Code via claude-code-router with `CLAUDE_CONFIG_DIR` isolation.
