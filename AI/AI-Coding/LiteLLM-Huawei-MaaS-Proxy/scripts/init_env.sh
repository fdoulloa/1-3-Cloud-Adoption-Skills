...
#   --auto                  — generate all secrets, prompt only for HUAWEI_MAAS_API_KEY
...
MAAS_API_KEY=$(prompt_value "HUAWEI_MAAS_API_KEY" "HUAWEI_MAAS_API_KEY (from ModelArts MaaS console, ap-southeast-1)" "" "yes")
